...
<div class="row">
    <div class="col-md-12 align-items-center">
        <h4 class="card-title">Community Activity</h4>
        ...
        <ul class="nav nav-tabs mb-3">
            ...
            <li class="nav-item">
                <a href="#community" data-toggle="tab" aria-expanded="true" class="nav-link active">
        ...
        <div class="card-body">
            <div class="tab-content">
                <div class="tab-pane show active" id="community">
                    <dl class="row">
